...
#set up plot window for 4 plots, adjust margins
par(mfcol=c(2,2),mar=c(4,4,2,1))

#________________________________________________________________________
#Plot 2
with(mydata, {
  plot(Global_active_power ~ newdate, type="l", xlab = "", 
...
#new plot
with(mydata, {
  plot(Voltage ~ newdate, type="l", xlab = "datetime", 
       ylab = "Voltage")
})
...
#new plot
with(mydata, {
  plot(Global_reactive_power ~ newdate, type="l", xlab = "datetime")
})
